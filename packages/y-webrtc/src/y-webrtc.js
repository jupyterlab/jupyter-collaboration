 ...
 * @property {function(string, string, string): Promise<any>} [loadDocument] - Function to load document content (format, type, path) => Promise
 */
 ...
 * @property {function({roomName:string}):void} WebrtcProviderEvent.firstClient
 */
