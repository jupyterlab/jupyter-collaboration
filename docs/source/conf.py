...
htmlhelp_basename = "JupyterServerYDocdoc"
...
latex_documents = [
    (
        master_doc,
        "JupyterServerYDoc.tex",
        "Jupyter Server YDoc Documentation",
        "https://jupyter.org",
        "manual",
    ),
]
...
man_pages = [(master_doc, "jupyterserverydoc", "Jupyter Server YDoc Documentation", [author], 1)]
